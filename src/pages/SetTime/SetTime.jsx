...
setRepeat((repeat) => newRepeat)
    ...
    function setAllTime(){
      if(document.getElementsByClassName('time_setter_break').length !==0){
        console.log('break set')
        newMinuteRest(document.getElementsByClassName('time_setter_break')[0].value,'minute','break')
        newSecondRest(document.getElementsByClassName('time_setter_break')[1].value,'second','break')
        newHourRest(document.getElementsByClassName('time_setter_break')[2].value,'hour','break')
      }
      if(document.getElementsByClassName('time_setter').length !== 0){
        console.log('repeat set')
        newRepeat(document.getElementsByClassName('time_setter')[0].value,'repeat')
      }
      if(document.getElementsByClassName('time_setter_work').length !== 0){
        newMinute(document.getElementsByClassName('time_setter_work')[0].value, 'minute','work')
        newSecond(document.getElementsByClassName('time_setter_work')[1].value, 'second','work')
        newHour(document.getElementsByClassName('time_setter_work')[2].value, 'hour','work')
        console.log()
      }
    }
        ...
        <div className={classes.box__page}>
          ...
          <div className={classes.set_place}>
            <SetTimeHeader paddingTop='10%'/>
              ...
              {props.repeat && <Repeat/>}
            <Link to='/worktime' onMouseDown={()=> setAllTime()}> 
